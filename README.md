> [!IMPORTANT] 
> This repository was merged into [actualbudget/actual](https://github.com/actualbudget/actual) in January and has been placed in a readonly state. For more information please visit our [Discord](https://discord.com/invite/pRYNYr4W5A).
