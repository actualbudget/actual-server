...
describe('Fortuneo', () => {
    describe('#normalizeTransaction', () => {
        ...
        it('extracts payee name from remittanceInformationUnstructured', () => {
            ...
            expect(normalizedTransaction3.creditorName).toBe('Google Payment I Dublin')
            ...
            expect(normalizedTransaction7.creditorName).toBe('Leclerc XXXX  Leclerc XXXX  44321IXCRT211141232')
        }
        );
    });
}
