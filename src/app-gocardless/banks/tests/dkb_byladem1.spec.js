...
describe('dkb_byladem1', function () {
  describe('#normalizeAccount', function () {
    it('should normalize the account information', function () {
      ...
      /** @type {import('../../gocardless.types.js').NormalizedAccountDetails} */
      const expected = {
  ...
  describe('#sortTransactions', function () {
    it('should sort by transaction id', function () {
      ...
      const transactionsRaw = [
        {
          transactionId: '2024-11-05-00.25.38.982769Z',
          transactionAmount: mockTransactionAmount,
        },
        {
          transactionId: '2024-11-05-01.25.38.982769Z',
          transactionAmount: mockTransactionAmount,
        },
        {
          transactionId: '2024-11-04-01.26.38.982769Z',
          transactionAmount: mockTransactionAmount,
        },
        {
          transactionId: '2024-11-05-01.26.38.982769Z',
          transactionAmount: mockTransactionAmount,
        },
      ];
